...
export default function DevicePage() {
  ...
  return (
    ...
    <main
      ...
      className={`smart-theme-page min-h-screen px-4 py-6 sm:px-8 ${darkMode ? "text-white" : "text-slate-700"}`}
    >
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <AppHeader
          eyebrow="Device"
          title={deviceId}
          subtitle="Roof Water Controller"
          ...
          actions={
            <GlobalHeaderActions>
              ...
              className={`flex items-center gap-2 rounded-2xl border px-4 py-2.5 text-sm font-semibold ${glassSoft}`}
            >
              <Settings size={17} />
              {editMode ? "Done" : "Edit"}
              </button>
