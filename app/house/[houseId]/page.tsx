...
export default function HousePage() {
  ...
  if (loading) {
  return (
    <main className={`smart-theme-page min-h-screen px-4 py-6 sm:px-6 ${darkMode ? "text-white" : "text-black"}`}>
      <div className="mx-auto max-w-6xl">

        {/* HOUSE HEADER SKELETON */}
        <div className={`mb-7 rounded-[30px] border p-6 shadow-2xl backdrop-blur-2xl sm:p-7 ${glass}`}>
  ...
  if (!house) {
    return (
      <main className={`smart-theme-page flex min-h-screen items-center justify-center px-4 ${darkMode ? "text-white" : "text-black"}`}>

        <div className="w-full max-w-md rounded-[30px] border shadow-2xl backdrop-blur-2xl p-8 text-center shadow-sm">
          ...
          actions={
            <GlobalHeaderActions>
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 rounded-2xl border border-red-400/20 bg-red-500/10 px-5 py-3 text-sm font-semibold text-red-500 transition hover:bg-red-500/15"
              >
                <Trash2 size={18} />
                Delete House
              </button>
...
>
      ...
      {showAddRoom && (
        ...
        >
          ...
          <div
            className="w-full max-w-md rounded-[30px] border shadow-2xl backdrop-blur-2xl p-7 shadow-2xl"
            onMouseDown={(event) =>
